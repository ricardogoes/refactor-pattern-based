...
namespace PatternRefactorings.MoveAccumulationVisitor.Better5
{
    //
    // STEP 4: Move every accept method to the type it is associated with (e.g. AcceptStringNode goes to StringNode)
    // Change it to take a TextExtractor (the Visitor) argument, and to be public.
    // Change it to pass VisitFoo "this"
    //
    ...
    public class Tag : Node
    {
        ...
        public void AcceptTag(TextExtractor textExtractor)
        {
