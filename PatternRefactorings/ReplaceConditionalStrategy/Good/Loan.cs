...
namespace PatternRefactorings.ReplaceConditionalStrategy.Good
{
    // Now replace conditional with polymorphism for Capital()
    public abstract class CapitalStrategy
    {
        public abstract decimal Capital(Loan loan);

        protected decimal UnusedRiskFactorFor(Loan loan)
        {
    ...
    public class AdvisedLineCapitalStrategy : CapitalStrategy
    {
    ...
    public class RevolverCapitalStrategy : CapitalStrategy
    {
        public override decimal Capital(Loan loan)
        {
